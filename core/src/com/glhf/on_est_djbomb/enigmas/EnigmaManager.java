...
public class EnigmaManager extends Table{
	...
	public EnigmaManager(boolean isHost , OnEstDjbombGame game , Stage stage) {
		...
		enigmes.add(enigme2);
		EnigmaLabyrinth enigme3 = new EnigmaLabyrinth(isHost,"labyrintheTuto.txt", game.getGameSocket());
		enigmes.add(enigme3);
		EnigmaFindTheImage enigme4 = new EnigmaFindTheImage(isHost);
		enigmes.add(enigme4);
		EnigmaSum enigme5 = new EnigmaSum(isHost);
		enigmes.add(enigme5);
		EnigmaLabyrinth enigme6 = new EnigmaLabyrinth(isHost,"labyrintheIntermédiaire.txt", game.getGameSocket());
		enigmes.add(enigme6);
		EnigmaPyramid enigme7 = new EnigmaPyramid(isHost);
		enigmes.add(enigme7);
		EnigmaCount enigme8 = new EnigmaCount(isHost);
		enigmes.add(enigme8);
		EnigmaLabyrinth enigme9 = new EnigmaLabyrinth(isHost,"labyrintheHard.txt", game.getGameSocket());
		enigmes.add(enigme9);
